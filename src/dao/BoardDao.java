...
public class BoardDao {
	...
	public List<Map<String, Object>> selectBoard(int board_no) {
		...
		String sql = "SELECT POST_NUM, POST_TITLE, POST_DATE, POST_WRITER, MEM_NAME" +
	...
	public int postInsert(ArrayList<Object> param){
		String sql = "INSERT INTO TAB_POST VALUES( (SELECT NVL(MAX(POST_NUM),0) +1 FROM TAB_POST) , ?, ?, ? ,sysdate , 0 , 1,null,? )";
	...
	public List<Map<String, Object>> commentList(int selectedPostNo) {
		...
		String sql = "SELECT COM_NUM, COM_WRITER, COM_CONTENT , COM_DATE , MEM_NAME" +
